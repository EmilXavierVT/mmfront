      ...
      <div className="split">
        <button type="button" className="split-card" onClick={() => onBook('catering')}>
          ...
          <div className="body">
            ...
            <div className="row">
              <span className="btn btn-primary">Build a menu <Icon name="arrow" size={16}/></span>
              <span className="price">Avg. ticket <b>4 200 kr</b></span>
            </div>
          </div>
        </button>
        <button type="button" className="split-card cleaning" onClick={() => onBook('cleaning')}>
          ...
          <div className="body">
            ...
            <div className="row">
              <span className="btn btn-blue">Book a crew <Icon name="arrow" size={16}/></span>
